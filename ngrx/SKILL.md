...
- For side effects like backend requests, navigation, deep linking (reflecting and consuming state from URL), scrolling, loading data based on URL path params, read [effects.md](references/effects.md).
